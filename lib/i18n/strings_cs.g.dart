...
class _TranslationsBookmarksCs implements TranslationsBookmarksEn {
	...
	@override String get filterSort => 'Filtrování a řazení';
	@override String get sorting => 'Řazení';
...
class _TranslationsBookmarksAddBookmarkCs implements TranslationsBookmarksAddBookmarkEn {
	...
	// Translations
	@override String get addBookmark => 'Přidání nové záložky';
	@override String get editBookmark => 'Úprava záložky';
	...
	@override String get urlValid => 'Validní URL';
	@override String get urlNotValid => 'Nevalidní URL';
	...
	@override String get tags => 'Štítky';
	@override String get noTagsAdded => 'Nepoužity žádné štítky';
...
class _TranslationsBookmarksBookmarkOptionsCs implements TranslationsBookmarksBookmarkOptionsEn {
	...
	@override String get shareThirdPartyApp => 'Sdílet pomocí externí aplikace';
...
class _TranslationsBookmarksShareOptionsCs implements TranslationsBookmarksShareOptionsEn {
	...
	@override String get shareExternallyDescription => 'Sdílet URL pomocí externí aplikace v systému';
...
extension on TranslationsCs {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'bookmarks.filterSort' => 'Filtrování a řazení',
			'bookmarks.sorting' => 'Řazení',
			'bookmarks.date' => 'Datum',
			'bookmarks.title' => 'Název',
			'bookmarks.ascendant' => 'Vzestupně',
			'bookmarks.descendant' => 'Sestupně',
			'bookmarks.addBookmark.addBookmark' => 'Přidání nové záložky',
			'bookmarks.addBookmark.editBookmark' => 'Úprava záložky',
			...
			'bookmarks.addBookmark.urlValid' => 'Validní URL',
			'bookmarks.addBookmark.urlNotValid' => 'Nevalidní URL',
			...
			'bookmarks.addBookmark.noTagsAdded' => 'Nepoužity žádné štítky',
			...
			'bookmarks.bookmarkOptions.shareThirdPartyApp' => 'Sdílet pomocí externí aplikace',
			...
			'bookmarks.shareOptions.shareExternallyDescription' => 'Sdílet URL pomocí externí aplikace v systému',
